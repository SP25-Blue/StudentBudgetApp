...
export const AdsProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
    ...
    ads.push(new Advertising("Amazon Ciber Monday", "Discover cypher monday offers with amazing prices!", "https://www.amazon.com/", "https://www.gamespot.com/a/uploads/screen_kubrick/1595/15950357/3610061-best-amazon-deals-cyber-monday-2019-promo12.jpg"));
